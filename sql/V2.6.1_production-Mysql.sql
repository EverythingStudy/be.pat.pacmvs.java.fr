...
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'1','脊髓（颈、胸、腰）','Spinal cord (cervical, thoracic, lumbar)',3,'N','39','SC',1,1);
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'2','肝脏','Liver',2,'N','12','LI',1,1);
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'3','肾脏','Kidneys',2,'N','1B','KI',1,1);
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'4','脾脏','Spleen',1,'N','45','SP',1,1);
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'4','胸腺','Thymus',1,'N','44','TH',1,1);
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'4','淋巴结，肠系膜','Lymph node, mesenteric',2,'N','46','MN',1,1);
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'5','垂体','Pituitary',1,'N','06','PI',1,1);
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'5','肾上腺','Adrenal glands',2,'N','01','AG',1,1);
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'5','胰腺','Pancreas',1,'N','05','PA',1,1);
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'6','心脏','Heart',1,'N','5E','HE',1,1);
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'6','主动脉','Aorta',1,'N','5D','AO',1,1);
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'6','肺（含支气管）','Lung with bronchi',2,'N','4C','LU',1,1);
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'7','舌','Tongue',1,'N','0D','TO',1,1);
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'7','胃（腺胃和非腺胃）','Stomach (glandular and non-glandular)',1,'N','10','SM',1,1);
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'7','肠，十二指肠','Duodenum',1,'N','19','DU',1,1);
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'7','肠，空肠','Jejunum',1,'N','18','JE',1,1);
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'8','肠，回肠（含派氏结）','Ileum (with Peyer’s Patch)',1,'N','17','IL',1,1);
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'8','肠，盲肠','Cecum',1,'N','14','CE',1,1);
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'8','肠，结肠','Colon',1,'N','15','CO',1,1);
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'8','肠，直肠','Rectum',1,'N','16','RE',1,1);
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'9','淋巴结，下颌','Lymph node, mandibular',2,'N','48','ML',1,1);
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'9','唾液腺，颌下腺','Salivary glands, mandibular',2,'N','0B','MD',1,1);
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'9','唾液腺，舌下腺','Salivary glands, sublingual',2,'N','0A','SD',1,1);
...
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'17','精囊腺','Seminal vesicles',2,'M','2D','SV',1,1);
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'17','凝固腺','Coagulating glands',2,'M','2B','CG',1,1);
...
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'20','大体损伤','Gross lesions observed at necropsy',1,'N','77','GL',1,1);
INSERT INTO tb_species_wax_code_template (species_id,wax_code,organ_name,organ_en,block_count,sex_flag,organ_code,abbreviation,create_by,update_by) VALUES ("1",'21','其他','Others',1,'N','00','AA',1,1);
