...
@Slf4j
@Component("Jejunum_3")
public class Jejunum_3ParserStrategyImpl extends AbstractCustomParserStrategy {

    /** 黏膜上皮+固有层 */
    private static final String STRUCTURE_EPITHELIUM_LAMINA = "31801E";
    /** 黏膜肌层+黏膜下层 */
    private static final String STRUCTURE_MUSCULAR_SUBMUCOSA = "31801F";
    /** 肌层 */
    private static final String STRUCTURE_MUSCULAR = "31800C";
    /** 淋巴小结 */
    private static final String STRUCTURE_LYMPH_NODULE = "318064";
    /** 淋巴组织 */
    private static final String STRUCTURE_LYMPHATIC = "318049";
    /** 组织轮廓 */
    private static final String STRUCTURE_OUTLINE = "318111";
    ...
    public void init() {
        ...
        log.info("Dog Jejunum_3ParserStrategyImpl init");
    }

    @Override
    public void alculationIndicators(JsonTask jsonTask) {
        log.info("犬空肠指标计算开始 singleId={}", jsonTask.getSingleId());
        Map<String, IndicatorAddIn> indicatorResultsMap = buildJejunumIndicators(jsonTask);
    ...
    /**
     * B 黏膜上皮+固有层面积 mm² - 31801E
     * C 黏膜肌层+黏膜下层面积 mm² - 31801F
     * D 肌层面积 mm² - 31800C
     * E 淋巴组织面积 mm² - 318049（若多个数据则相加输出）
     * F 组织轮廓面积 mm² - 318111（辅助指标5，不单独展示）
     * G 淋巴小结数量 个 - 318064
     * 1 黏膜上皮+固有层面积占比 % = B/F
     * 2 黏膜肌层+黏膜下层面积占比 % = C/F
     * 3 肌层面积占比 % = D/F
     ...
     * 5 空肠面积 mm² = F
     */
    private Map<String, IndicatorAddIn> buildJejunumIndicators(JsonTask jsonTask) {
        ...
        // 5 空肠面积 mm² = F
        result.put("空肠面积", createNameIndicator("Jejunum area", areaF.setScale(3, RoundingMode.HALF_UP).toString(), SQ_MM, STRUCTURE_OUTLINE));
