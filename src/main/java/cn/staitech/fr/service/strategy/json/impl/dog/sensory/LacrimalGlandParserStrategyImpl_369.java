...
@Component
@Slf4j
public class LacrimalGlandParserStrategyImpl_369 extends AbstractCustomParserStrategy {
    ...
    public LacrimalGlandParserStrategyImpl_369(
...
//        map.put("组织轮廓面积", new IndicatorAddIn("", DecimalUtils.setScale3(areaD), SQ_MM, CommonConstant.NUMBER_0, "369111"));
        ...
        List<BigDecimal> statC = listC.stream().map(annC -> new BigDecimal(areaUtils.convertToMicrometer(annC.getStructureAreaNum().toString()))).collect(Collectors.toList());
