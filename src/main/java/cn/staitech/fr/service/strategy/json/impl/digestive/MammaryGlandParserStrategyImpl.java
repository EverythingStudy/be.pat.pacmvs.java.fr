...
public class MammaryGlandParserStrategyImpl extends AbstractCustomParserStrategy {
    ...
    public void alculationIndicators(JsonTask jsonTask) {
        ...
        map.put("乳腺面积", new IndicatorAddIn("Mammary gland area", DecimalUtils.setScale3(h.subtract(organAreaA).subtract(organAreaB)), "平方毫米"));

        map.put("淋巴结面积", new IndicatorAddIn("Lymph node area", DecimalUtils.setScale3(organAreaA), "平方毫米", CommonConstant.NUMBER_1));
        // 皮肤面积	G	平方毫米	此数据使用乳腺中皮肤数据 (乳腺皮肤公用)
        map.put("皮肤面积", new IndicatorAddIn("Skin area", DecimalUtils.setScale3(organAreaB), "平方毫米", CommonConstant.NUMBER_1));
        map.put("乳腺腺泡/导管数量", new IndicatorAddIn("Number of acinus and ducts", organAreaCount.toString(), "个", CommonConstant.NUMBER_1));
        map.put("乳腺腺泡/导管面积（全片）", new IndicatorAddIn("Breast acinar/ductal area (all)", DecimalUtils.setScale3(organArea1), "平方毫米", CommonConstant.NUMBER_1));
        map.put("结缔组织面积", new IndicatorAddIn("Connective tissue area", DecimalUtils.setScale3(organArea2), "平方毫米", CommonConstant.NUMBER_1));
        map.put("组织轮廓面积", new IndicatorAddIn("Organizational contour area", DecimalUtils.setScale3(h), "平方毫米", CommonConstant.NUMBER_1));
        ...
        map.put("表皮角质层面积", new IndicatorAddIn("Epidermal stratum corneum area", DecimalUtils.setScale3(organArea3), "平方毫米", CommonConstant.NUMBER_1));

        // 表皮基底层+棘层+颗粒层面积	B	平方毫米	若多个数据则相加输出
        map.put("表皮基底层+棘层+颗粒层面积", new IndicatorAddIn("Area of basal layer+spinous layer+granular layer of epidermis", DecimalUtils.setScale3(organArea4), "平方毫米", CommonConstant.NUMBER_1));
        ...
        // 毛囊面积（全片）	H	平方毫米	无
        map.put("毛囊面积（全片）", new IndicatorAddIn("Mucous sac area (all)", DecimalUtils.setScale3(organAreaH), "平方毫米", CommonConstant.NUMBER_1));
        ...
        map.put("皮肤面积", new IndicatorAddIn("Skin area", DecimalUtils.setScale3(organAreaB), "平方毫米"));
