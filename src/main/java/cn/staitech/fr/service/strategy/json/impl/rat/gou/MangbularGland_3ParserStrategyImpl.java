...
public class MangbularGland_3ParserStrategyImpl extends AbstractCustomParserStrategy {
    ...
    public void alculationIndicators(JsonTask jsonTask) {
        ...
        commonJsonParser.putSingleAnnotationDynamicData(jsonTask, "30B06F", annotationC, 1);
        //indicatorResultsMap.put("导管面积（单个）", new IndicatorAddIn("", DecimalUtils.setScale3(ductAreaPer), MULTIPLIED_SQ_UM_THOUSAND, CommonConstant.NUMBER_1, "30B06F"));
        indicatorResultsMap.put("导管面积（全片）", new IndicatorAddIn("", DecimalUtils.setScale3(ductAreaTotal), MULTIPLIED_SQ_UM_THOUSAND, CommonConstant.NUMBER_1, "30B06F"));
        indicatorResultsMap.put("腺泡面积", new IndicatorAddIn("", DecimalUtils.setScale3(acinusArea), SQ_MM, CommonConstant.NUMBER_1, "30B06D"));
        indicatorResultsMap.put("腺泡细胞核数量", new IndicatorAddIn("", acinusNucleusCount.toString(), PIECE, CommonConstant.NUMBER_1, "30B06E"));
        //indicatorResultsMap.put("组织轮廓", new IndicatorAddIn("", DecimalUtils.setScale3(slideArea), "平方毫米", CommonConstant.NUMBER_1, "30B111"));

        // 产品呈现指标
        indicatorResultsMap.put("颌下腺面积", new IndicatorAddIn("Submandibular gland area", DecimalUtils.setScale3(slideArea), SQ_MM, "30B111"));
        ...
        if (slideArea.compareTo(BigDecimal.ZERO) != 0) {
            ...
            indicatorResultsMap.put("导管面积占比（全片）", new IndicatorAddIn("Ducts area% (all)", DecimalUtils.setScale3(ductAreaRatioAll), PERCENTAGE, areaUtils.getStructureIds("30B06F", "30B111")));

            // 腺泡面积占比 = C / E
            BigDecimal acinusAreaRatio = commonJsonParser.getProportion(acinusArea, slideArea);
            indicatorResultsMap.put("腺泡面积占比", new IndicatorAddIn("Acinus area%", DecimalUtils.setScale3(acinusAreaRatio), PERCENTAGE, areaUtils.getStructureIds("30B06D", "30B111")));
        }
        ...
        if (acinusArea.compareTo(BigDecimal.ZERO) != 0) {
            ...
            indicatorResultsMap.put("腺泡细胞核密度", new IndicatorAddIn("Nucleus density of acinar cell", DecimalUtils.setScale3(acinusNucleusDensity), SQ_MM_PIECE, areaUtils.getStructureIds("30B06E", "30B06D")));
        }
