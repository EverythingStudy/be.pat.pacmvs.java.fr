...
public class SeminalVesicleGlandParserStrategyImpl implements ParserStrategy {
    ...
    private static Annotation processJsonElement(JsonNode element, ExecutorService executorService, Map<String, Long> pathologicalMap, JsonTask jsonTask) {
        ...
        try {
            Future<Annotation> future = executorService.submit(() -> SeminalVesicleGlandParserStrategyImpl.handleSingleJsonElement(element, pathologicalMap, jsonTask));
