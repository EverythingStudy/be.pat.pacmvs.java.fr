...
public abstract class AbstractCustomParserStrategy implements CustomParserStrategy{
    ...
    protected static Annotation handleSingleJsonElement(JsonNode element, Map<String, Long> pathologicalMap, JsonTask jsonTask) {
        if (element.isObject()) {
    ...
    protected static void processObjectNode(ObjectMapper objectMapper, JsonParser jsonParser, List<JsonNode> elementsList) throws IOException {
    ...
    protected static Annotation processJsonElement(JsonNode element, ExecutorService executorService, Map<String, Long> pathologicalMap, JsonTask jsonTask) {
        Annotation annotation = null;
        try {
            Future<Annotation> future = executorService.submit(() -> handleSingleJsonElement(element, pathologicalMap, jsonTask));
            annotation = future.get();
    ...
    protected void batchProcessAndSave(Annotation annotation, int batchSize, int threadCount) {
