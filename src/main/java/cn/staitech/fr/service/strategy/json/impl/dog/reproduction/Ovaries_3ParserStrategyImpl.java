...
public class Ovaries_3ParserStrategyImpl extends AbstractCustomParserStrategy {
    ...
    public void alculationIndicators(JsonTask jsonTask) {
       ...
       /* // 1=A：卵泡数量
        ...
        // 3=A/G：卵泡密度
        BigDecimal ag3 = this.commonJsonParser.bigDecimalDivideCheck(BigDecimal.valueOf(countA), new BigDecimal(organAreaG));
        ...
        // 6=E/G：血管外红细胞面积占比
        BigDecimal eg6 = this.commonJsonParser.bigDecimalDivideCheck(organAreaE, new BigDecimal(organAreaG).multiply(new BigDecimal(1000000)));
        ...
        // 7=F/G：血管内红细胞面积占比
        BigDecimal fg7 = this.commonJsonParser.bigDecimalDivideCheck(organAreaF, new BigDecimal(organAreaG).multiply(new BigDecimal(1000000)));
        ...
        // 8=G：卵巢面积
        resultsMap.put("卵巢面积", createNameIndicator("Ovary area", new BigDecimal(organAreaG), SQ_MM, "324111"));
