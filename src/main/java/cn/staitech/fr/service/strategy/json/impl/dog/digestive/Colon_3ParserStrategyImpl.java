...
@Slf4j
@Component("Colon_3")
public class Colon_3ParserStrategyImpl extends AbstractCustomParserStrategy {

    /** 黏膜上皮+固有层 */
    private static final String STRUCTURE_EPITHELIUM_LAMINA = "31501E";
    /** 黏膜上皮+黏膜下层 */
    private static final String STRUCTURE_EPITHELIUM_SUBMUCOSA = "31501F";
    /** 肌层 */
    private static final String STRUCTURE_MUSCULAR = "31500C";
    /** 淋巴组织 */
    private static final String STRUCTURE_LYMPHATIC = "315049";
    /** 组织轮廓 */
    private static final String STRUCTURE_OUTLINE = "315111";
    ...
    public void init() {
        ...
        log.info("Dog Colon_3ParserStrategyImpl init");
    }

    @Override
    public void alculationIndicators(JsonTask jsonTask) {
        log.info("犬结肠指标计算开始 singleId={}", jsonTask.getSingleId());
        Map<String, IndicatorAddIn> indicatorResultsMap = buildColonIndicators(jsonTask);
    ...
    /**
     * A 黏膜上皮+固有层面积 mm² - 31501E
     * B 黏膜上皮+黏膜下层面积 mm² - 31501F
     * C 肌层面积 mm² - 31500C
     * D 淋巴组织面积 mm² - 315049（若多个数据则相加输出）
     * E 组织轮廓面积 mm² - 315111（辅助指标5，不单独展示）
     * 1 黏膜上皮+固有层面积占比 % = A/E
     * 2 黏膜上皮+黏膜下层面积占比 % = B/E
     * 3 肌层面积占比 % = C/E
     * 4 淋巴组织面积占比 % = D/E
     * 5 结肠面积 mm² = E
     */
    private Map<String, IndicatorAddIn> buildColonIndicators(JsonTask jsonTask) {
        ...
        // 5 结肠面积 mm² = E
        result.put("结肠面积", createNameIndicator("Colon area", areaE.setScale(3, RoundingMode.HALF_UP).toString(), SQ_MM, STRUCTURE_OUTLINE));
        return result;
    }
