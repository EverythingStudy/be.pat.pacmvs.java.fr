...
public class SublingualGlandParserStrategyImpl extends AbstractCustomParserStrategy {
    ...
    public void alculationIndicators(JsonTask jsonTask) {
        ...
        indicatorResultsMap.put("腺泡平均面积", new IndicatorAddIn("Average area of acinus", commonJsonParser.getProportionMultiply(organArea2, new BigDecimal(count)).toString(), "10³平方微米", CommonConstant.NUMBER_0));
