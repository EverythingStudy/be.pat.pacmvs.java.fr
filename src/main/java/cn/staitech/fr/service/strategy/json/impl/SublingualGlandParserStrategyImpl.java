...
//        indicatorResultsMap.put("导管内腔面积（单个）", new IndicatorAddIn(CommonConstant.SINGLE_RESULT, CommonConstant.NUMBER_1,areaUtils.getStructureIds("10A06F","10A121")));
        ...
        indicatorResultsMap.put("腺泡平均面积", new IndicatorAddIn("Average area of acinus", commonJsonParser.getProportionMultiply(organArea2.multiply(BigDecimal.valueOf(1000L)), new BigDecimal(count)).toString(), SQ_UM_THOUSAND, CommonConstant.NUMBER_0,"10A06D"));
