...
public class BoneWithBoneMarrowTibiaStrategyImpl extends AbstractCustomParserStrategy {
    ...
    public void alculationIndicators(JsonTask jsonTask) {
        ...
        indicatorResultsMap.put("生长骨骺板面积", new IndicatorAddIn("Physis area", areaUtils.convertToSquareMicrometer(organAreaCount.toString()), SQ_MM_PIECE, CommonConstant.NUMBER_1, "151022"));
        ...
        indicatorResultsMap.put("股骨面积", new IndicatorAddIn("Femur area", organArea.toString(), SQ_MM, CommonConstant.NUMBER_0, "151111"));
