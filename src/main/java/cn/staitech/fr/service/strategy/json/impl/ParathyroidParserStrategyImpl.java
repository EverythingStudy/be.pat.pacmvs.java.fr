...
//		}
		BigDecimal areaDecimalB = getOrganArea(jsonTask, "106111").getStructureAreaNum();
		...
		if(areaDecimalB.compareTo(BigDecimal.ZERO) != 0) {
			indicatorResultsMap.put("甲状旁腺面积", new IndicatorAddIn("Parathyroid gland area", String.valueOf(areaDecimalB.setScale(3, RoundingMode.HALF_UP)), SQ_UM_THOUSAND, "0"));
		}

		if(bigDecimaE.compareTo(BigDecimal.ZERO) != 0) {
			indicatorResultsMap.put("主细胞核密度", new IndicatorAddIn("Nucleus density of chief cell", String.valueOf(bigDecimaE.setScale(3, RoundingMode.HALF_UP)), SQ_UM_PICE, "0"));
		}
