...
@Slf4j
@Component("Ileum_3")
public class Ileum_3ParserStrategyImpl extends AbstractCustomParserStrategy {

    /** 黏膜上皮+固有层 */
    private static final String STRUCTURE_EPITHELIUM_LAMINA = "31701E";
    /** 黏膜肌层+黏膜下层 */
    private static final String STRUCTURE_MUSCULAR_SUBMUCOSA = "31701F";
    /** 肌层 */
    private static final String STRUCTURE_MUSCULAR = "31700C";
    /** 淋巴小结 */
    private static final String STRUCTURE_LYMPH_NODULE = "317064";
    /** 淋巴组织 */
    private static final String STRUCTURE_LYMPHATIC = "317049";
    /** 组织轮廓 */
    private static final String STRUCTURE_OUTLINE = "317111";
    ...
    public void init() {
        ...
        log.info("Dog Ileum_3ParserStrategyImpl init");
    }

    @Override
    public void alculationIndicators(JsonTask jsonTask) {
        log.info("犬回肠指标计算开始 singleId={}", jsonTask.getSingleId());
        Map<String, IndicatorAddIn> indicatorResultsMap = buildIleumIndicators(jsonTask);
    ...
    /**
     * B 黏膜上皮+固有层面积 mm² - 31701E
     * C 黏膜肌层+黏膜下层面积 mm² - 31701F
     * D 肌层面积 mm² - 31700C
     * E 淋巴组织面积 mm² - 317049（若多个数据则相加输出）
     * F 组织轮廓面积 mm² - 317111（辅助指标5，不单独展示）
     * G 淋巴小结数量 个 - 317064
     * 1 黏膜上皮+固有层面积占比 % = B/F
     * 2 黏膜肌层+黏膜下层面积占比 % = C/F
     * 3 肌层面积占比 % = D/F
     ...
     * 5 回肠面积 mm² = F
     */
    private Map<String, IndicatorAddIn> buildIleumIndicators(JsonTask jsonTask) {
        ...
        // 5 回肠面积 mm² = F
        result.put("回肠面积", createNameIndicator("Ileum area", areaF.setScale(3, RoundingMode.HALF_UP).toString(), SQ_MM, STRUCTURE_OUTLINE));
