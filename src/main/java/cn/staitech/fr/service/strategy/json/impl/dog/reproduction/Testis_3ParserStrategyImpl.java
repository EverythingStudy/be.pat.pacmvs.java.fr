...
public class Testis_3ParserStrategyImpl extends AbstractCustomParserStrategy {
    ...
    public void alculationIndicators(JsonTask jsonTask) {
        ...
        // B：生精小管面积（全片）mm2
        BigDecimal organAreaB = this.commonJsonParser.getOrganArea(jsonTask, "32E0FA").getStructureAreaNum();
        // C：生精小管周长（单个）μm
        ...
        // D：生精小管数量
        Integer countD = this.commonJsonParser.getOrganArea(jsonTask, "32E0FA").getCount();
        // 生精小管内腔面积（单个）
