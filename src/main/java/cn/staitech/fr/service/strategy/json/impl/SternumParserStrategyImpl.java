...
@Slf4j
@Component("Sternum")
public class SternumParserStrategyImpl implements ParserStrategy {
	...
	private static Annotation processJsonElement(JsonNode element, ExecutorService executorService, Map<String, Long> pathologicalMap, JsonTask jsonTask,String resolutionX) {
		...
		try {
			Future<Annotation> future = executorService.submit(() -> SternumParserStrategyImpl.handleSingleJsonElement(element, pathologicalMap,jsonTask,resolutionX));
