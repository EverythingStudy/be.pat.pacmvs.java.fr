...
//		}
		...
		*/
		...
		indicatorResultsMap.put("红细胞面积", new IndicatorAddIn("", String.valueOf(bigDecimalE.setScale(3, RoundingMode.HALF_UP)), SQ_UM_THOUSAND, "1"));
		indicatorResultsMap.put("脂肪细胞面积", new IndicatorAddIn("", String.valueOf(bigDecimalF.setScale(3, RoundingMode.HALF_UP)), SQ_UM_THOUSAND, "1"));
		...
		*/
		...
		if(bigDecimalH.compareTo(BigDecimal.ZERO) != 0) {
			indicatorResultsMap.put("胸骨面积", new IndicatorAddIn("Sternum area", String.valueOf(bigDecimalH.setScale(3, RoundingMode.HALF_UP)), SQ_MM, "0"));
		}
