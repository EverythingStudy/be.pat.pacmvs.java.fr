...
public class ThyroidGlandParserStrategyImpl implements ParserStrategy {
    ...
    public void alculationIndicators(JsonTask jsonTask) {
        ...
        // H-I
        BigDecimal hSubtractI = new BigDecimal(accurateArea).subtract(parathyroidGlandArea);

        //        血管面积占比	4	%	Vessel area%	4=C/(H-I) 	运算前注意统一单位
        BigDecimal vesselAreaRate = vesselArea.divide(hSubtractI);
        indicatorResultsMap.put("血管面积占比", new IndicatorAddIn("Vessel area", vesselAreaRate.toString(), "%"));

        //        血管内红细胞面积占比	5	%	Intravascular erythrocyte area%	5=D/(H-I) 	运算前注意统一单位
        BigDecimal intravascularErythrocyteAreaRate = intravascularErythrocyteArea.divide(hSubtractI);
        ...
        //        血管外红细胞面积占比	6	%	Extravascular erythrocyte area%	6=E/(H-I) 	运算前注意统一单位
        BigDecimal extravascularErythrocyteAreaRate = extravascularErythrocyteArea.divide(hSubtractI);
        ...
        //        肥大细胞密度	7	个/平方毫米	Density of mast cells	7=F/(H-I) 	运算前注意统一单位
        BigDecimal densityOfMastCellsRate = new BigDecimal(densityOfMastCells).divide(hSubtractI);
        indicatorResultsMap.put("肥大细胞密度", new IndicatorAddIn("Density of mast cells", densityOfMastCellsRate.toString(), "个/平方毫米"));
