...
@Slf4j
@Component("Muscle")
public class MuscleParserStrategyImpl implements ParserStrategy {
    ...
    private static Annotation processJsonElement(JsonNode element, ExecutorService executorService, Map<String, Long> pathologicalMap, JsonTask jsonTask) {
        ...
        try {
            Future<Annotation> future = executorService.submit(() -> MuscleParserStrategyImpl.handleSingleJsonElement(element, pathologicalMap, jsonTask));
...
//                    }
    ...
    public void alculationIndicators(JsonTask jsonTask) {
        ...
        indicatorResultsMap.put("骨骼肌面积", new IndicatorAddIn("Skeletal muscle area", singleSlide.getArea(), "平方微米"));
