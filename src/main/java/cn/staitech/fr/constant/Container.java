...
public class Container {
    ...
    public static final Map<Integer, String> STRUCTURE_JSON_STATUS = new ImmutableMap.Builder<Integer, String>()
            //0未进行解析、1解析中、2解析成功、3解析失败
            .put(0, "未进行解析")
            .put(1, "解析中")
            .put(2, "解析成功")
            .put(3, "解析失败")
            .build();
    public static final Map<Integer, String> STRUCTURE_AI_STATUS = new ImmutableMap.Builder<Integer, String>()
            .put(0, "成功")
            .put(1, "失败")
            .build();
}
