...
public enum ColorTypeEnum {
    FLUORESCENCE(1, "荧光标记染色", "Immunofluorescence"),
    IMMUNOHISTOCHEMICAL(2, "免疫组织化学染色", "Immunohistochemical"),
    HE_STAINING(3, "HE染色", "HE staining"),
    MASSON_STAINING(4, "Masson染色", "Masson staining"),
    VAN_GIESON_STAINING(5, "Van Gieson染色", "Van Gieson staining"),
    VICTORIA_BLUE_STAINING(6, "维多利亚蓝染色", "Victoria Blue staining"),
    SUDAN_STAINING(7, "苏丹III/IV染色", "Sudan III/IV"),
    OIL_RED_STAINING(8, "油红O染色", "Oil Red O"),
    PAS_STAINING(9, "PAS糖原染色", "PAS"),
    AB_PAS_STAINING(10, "AB-PAS染色", "AB-PAS"),
    CONGO_RED_STAINING(11, "刚果红染色(甲醇)", "Congo red"),
    ...
    LFB_MYELIN_STAINING(15, "LFB髓鞘染色", "Luxol Fast Blue myelin"),
    TUNEL_STAINING(16, "Tunel染色", "Tunel"),
    KI67(17, "Ki67", "Ki67"),
    OTHER(20, "其他", "Other"),
    ARGYROPHILIC_STAINING(21, "嗜银染色", "Argyrophilic staining");
