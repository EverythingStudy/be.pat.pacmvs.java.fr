...
@Data
public class SingleSlideSelectBy {
    ...
    @ApiModelProperty(value = "单脏器切片缩略图")
    private String singleThumbUrl;

    @ApiModelProperty(value = "脏器标签id")
    private Long categoryId;

    @ApiModelProperty(value = "单脏器切片描述")
    private String description;

    @ApiModelProperty(value = "单脏器切片预测状态(0未预测、1预测成功、2预测失败、3预测中)")
    private String forecastStatus;

    @ApiModelProperty(value = "单脏器切片诊断状态(人工诊断状态 0：未诊断；1：已诊断)")
